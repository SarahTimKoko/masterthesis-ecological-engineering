...
#| label: fig-mca-plots-baeume-vertical-wide
#| fig.width: 10   # --- ERHÖHT: Mehr Breite für die Plots ---
#| fig.height: 25  # (Höhe bleibt, war ja gut)
#| out.width: "95%" # --- ERHÖHT: Nutzt fast die volle Seitenbreite ---
#| out.height: "auto"
...
# --- ANGEPASSTE BREITE (für ggsave) ---
ggsave("02_export/plots/mca_gesamtergebnis_alle_szenarien_baeume_vertical.png",
       plot = plot_mca_total_baeume, width = 10, height = 20) # width erhöht
# ------------------------------------
...
ggsave("02_export/plots/mca_detail_gruppen_alle_szenarien_baeume_vertical.png",
       plot = plot_mca_stacked_baeume, width = 11, height = 20) # width erhöht
# ------------------------------------
```
