...
ggsave("02_export/plots/Abb_Baeume_Raumbedarf_clean.png", 
       plot = plot_raum, width = 10, height = 8, dpi = 300)
```
![Alternative Bildunterschrift](02_export/plots/Abb_Baeume_Raumbedarf_clean.png)

```{r}
# -------------------------------------------------------
# TEIL 2: ÖKOLOGISCHE LEISTUNG (Optimiert für Lesbarkeit)
# -------------------------------------------------------
...
plot_leistung <- ggplot(df_leistung, 
  ...
  facet_wrap(~facet_label, ncol = 1, scales = "free_y", strip.position = "top") +
  
  scale_fill_manual(values = colors_baeume) +
  
  # HIER GEÄNDERT: Früherer Umbruch (width = 15) gegen breite Textblöcke
  ...
  theme(
    ...
    # HIER GEÄNDERT: Schrift kleiner (7) und vjust=1 für sauberen 45-Grad-Anschluss
    axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 9, color = "black"),
    
    # Ränder: Unten und Links genug Platz
    plot.margin = margin(t = 5, r = 10, b = 40, l = 10, unit = "mm")
  )
...
```{r}
#| include: false
# Speichern (Breite 12 reicht oft, wenn die Schrift klein genug ist)
ggsave("02_export/plots/Abb_Baeume_Leistung_clean.png", 
       plot = plot_leistung, width = 12, height = 14, dpi = 300)
