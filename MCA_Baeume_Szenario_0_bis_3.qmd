...
# -------------------------------------------------------
# TEIL 1: RAUMBEDARF (Horizontal & Lesbar)
# -------------------------------------------------------

# 1. Daten filtern & Bereinigen (bleibt gleich)
...
plot_raum <- ggplot(df_raum, 
  ...
  # HIER DIE ÄNDERUNG: Diagramm drehen
  coord_flip() +
  
  scale_fill_manual(values = colors_baeume) +
  
  # Text darf jetzt breiter laufen (da horizontal)
  ...
  theme(
    ...
    # WICHTIG: Gitterlinien tauschen! 
    # Durch coord_flip() ist die x-Achse jetzt optisch die vertikale Linie.
    # Wir brauchen aber Gitterlinien für die Werte (jetzt horizontal unten), also panel.grid.major.x
    panel.grid.major.x = element_line(color = "grey90", linewidth = 0.2),
    panel.grid.major.y = element_blank(),
    
    # Achsenbeschriftung: Gerade stellen (kein Winkel mehr nötig)
    axis.text.y = element_text(size = 10, color = "black"), # Baumnamen
    axis.text.x = element_text(size = 10, color = "black"), # Werte
...
#| include: false
# Speichern: 
# Breite normal (10-12), aber HÖHE (height) gross genug machen für die Liste!
