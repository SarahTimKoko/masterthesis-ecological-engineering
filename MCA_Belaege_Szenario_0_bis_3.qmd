...
#| fig.width: 10   # Weniger Breite nötig, da Plots untereinander
#| fig.height: 25  # MEHR Höhe nötig, da 4 Plots übereinander
...
ggsave("02_export/plots/mca_gesamtergebnis_alle_szenarien_vertical.png", 
       plot = plot_mca_total, width = 8, height = 15) # Höhe anpassen!
# ----------------------------------------------------
...
ggsave("02_export/plots/mca_detail_gruppen_alle_szenarien_vertical.png", 
       plot = plot_mca_stacked, width = 9, height = 15) # Höhe anpassen!
# ----------------------------------------------------
