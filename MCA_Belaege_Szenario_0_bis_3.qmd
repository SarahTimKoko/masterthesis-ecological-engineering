...
![Alternative Bildunterschrift](02_export/plots/check_01_rohwerte_verteilung_belaege.png)
...
![Alternative Bildunterschrift](02_export/plots/Abb_Lebenszyklus_Kosten_Stacked_Zyklen.png)

```{r}
# -------------------------------------------------------
# TEIL 3: UMWELT (Korrigiert: Beschriftung überall an)
# -------------------------------------------------------
...
p_co2 <- ggplot(df_co2, aes(x = option_sortiert, y = wert, fill = kategorie)) + 
  ...
  # Titel angepasst (kein X-Titel, aber Y-Titel)
  ...
  theme(
    ...
    # HIER GEÄNDERT: Beschriftung wieder EINSCHALTEN!
    axis.text.x = element_text(angle = 45, hjust = 1, size = 10, color = "black"),
...
# Da p_co2 jetzt Text unten hat, brauchen wir ggf. etwas mehr Gesamthöhe beim Speichern.
...
![Alternative Bildunterschrift](02_export/plots/Abb_Lebenszyklus_Umwelt_clean.png)
...
![Alternative Bildunterschrift](02_export/plots/check_02_normierte_scores_belaege.png)
```{r}
# --- PRÜFUNG BLOCK 6 ---
...
![Alternative Bildunterschrift](02_export/plots/mca_gesamtergebnis_s0_belaege.png)
...
```
![Alternative Bildunterschrift](02_export/plots/mca_gesamtergebnis_s1_belaege.png)
...
![Alternative Bildunterschrift](02_export/plots/mca_detail_gruppen_s1_belaege.png)
...
![Alternative Bildunterschrift](02_export/plots/mca_gesamtergebnis_s2_belaege.png)
```{r}
...
![Alternative Bildunterschrift](02_export/plots/mca_detail_gruppen_s2_belaege.png)
...
```
![Alternative Bildunterschrift](02_export/plots/mca_gesamtergebnis_s3_belaege.png)
...
```
![Alternative Bildunterschrift](02_export/plots/mca_detail_gruppen_s3_belaege.png)