...
# -------------------------------------------------------
# PLOT: 100-Jahres-Bilanz der Beläge (KORRIGIERT V2)
# -------------------------------------------------------

# 1. Daten vorbereiten
df_plot_belaege_100a <- df_belaege_raw %>% 
  select(
    # Wir nutzen jetzt 'option' und 'belagskategorie' (klein)
    `option`,                
    `belagskategorie`,  
    `kosten`,
    `kosten_100a`,           
  ...
  rename(
    belag = `option`,             # 'option' wird zu 'belag'
    kategorie = `belagskategorie` # 'belagskategorie' wird zu 'kategorie'
  ) %>%
...
ggsave("02_export/plots/check_05_bilanz_100a_belaege_final_blau.png", 
       plot = plot_belaege_100a_final, width = 10, height = 14, bg = "white")
```
