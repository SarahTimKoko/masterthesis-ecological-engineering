...
df_plot_belaege_100a <- df_belaege %>% 
  ...
  mutate(facet_label = case_when(
    # Hier definieren wir Labels für BEIDE Kostenarten
    kriterium == "initialkosten" ~ "1. Reine Erstellungskosten (Info)\n[CHF/m²]",
    kriterium == "initialkosten_100a" ~ "2. Gesamtkosten 100a (Bewertet)\n[CHF/m²]",
...
# Prüfen, ob die Daten jetzt da sind:
print("--- Check Min/Max ---")
