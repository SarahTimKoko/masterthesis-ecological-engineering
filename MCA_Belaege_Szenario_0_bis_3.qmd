...
#| label: fig-mca-plots-vertical
#| fig.width: 11   # Weniger Breite nötig, da Plots untereinander
#| fig.height: 45  # MEHR Höhe nötig, da 4 Plots übereinander
#| out.width: "95%" # Etwas kleiner als 95%, um Ränder zu haben
#| out.height: "auto"
#| dpi: 300 
...
plot_mca_total <- ggplot(df_mca_total, 
  ...
  # --- ÄNDERUNG HIER: ncol = 1 ---
  # Erzwingt die Anordnung in EINER Spalte (untereinander)
...
# --- ANGEPASSTE DIMENSIONEN (für vertikalen Plot) ---
ggsave("02_export/plots/mca_gesamtergebnis_alle_szenarien_vertical.png", 
       plot = plot_mca_total, width = 11, height = 40) # Höhe anpassen!
# ----------------------------------------------------
...
# --- ANGEPASSTE DIMENSIONEN (für vertikalen Plot) ---
ggsave("02_export/plots/mca_detail_gruppen_alle_szenarien_vertical.png", 
       plot = plot_mca_stacked, width = 12, height = 40) # Höhe anpassen!
# ----------------------------------------------------
